...
**FamilyShopper** — современное Android-приложение для управления списками покупок внутри семьи. Проект построен на полностью декларативном интерфейсе (Jetpack Compose) и предлагает гибкие режимы работы: от полностью приватных локальных списков до общих облачных пространств с разграничением прав доступа.
